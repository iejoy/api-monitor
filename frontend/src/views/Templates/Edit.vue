...
const fetchTemplate = async () => {
  try {
    ...
    const formData = {
      ...
      alert_title_template: response.alert_title_template || '',
      alert_content_template: response.alert_content_template || '',
      webhook_url: response.config?.webhook_url || '',
...
const submitForm = async () => {
  ...
  try {
    ...
    console.log('提交的数据:', templateData)
    
    await alertsApi.updateAlertTemplate(templateId, templateData)
